...
# print(cc.L_u)
# print(cc.proj.shape)
#simplicial_nn = conv2nn(F_in=1, F_intermediate=[16,16], F_out=1, K=5, K1=2, K2=2, laplacian=cc.L, laplacian_l=cc.L_l, laplacian_u=cc.L_u, projection_matrix=cc.proj, sigma=nn.ReLU(), device=device, model='snn')
